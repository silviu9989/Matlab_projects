function varargout = UWB_GUI2_export(varargin)
% UWB_GUI2_export MATLAB code for UWB_GUI2_export.fig
%      UWB_GUI2_export, by itself, creates a new UWB_GUI2_export or raises the existing
%      singleton*.
%
%      H = UWB_GUI2_export returns the handle to a new UWB_GUI2_export or the handle to
%      the existing singleton*.
%
%      UWB_GUI2_export('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UWB_GUI2_export.M with the given input arguments.
%
%      UWB_GUI2_export('Property','Value',...) creates a new UWB_GUI2_export or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before UWB_GUI2_export_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to UWB_GUI2_export_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help UWB_GUI2_export

% Last Modified by GUIDE v2.5 18-Dec-2021 13:16:48

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @UWB_GUI2_export_OpeningFcn, ...
                   'gui_OutputFcn',  @UWB_GUI2_export_OutputFcn, ...
                   'gui_LayoutFcn',  @UWB_GUI2_export_LayoutFcn, ...
                   'gui_Callback',   []);
...
% --- Executes just before UWB_GUI2_export is made visible.
function UWB_GUI2_export_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to UWB_GUI2_export (see VARARGIN)

% Choose default command line output for UWB_GUI2_export
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes UWB_GUI2_export wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = UWB_GUI2_export_OutputFcn(hObject, eventdata, handles) 
...
function h1 = UWB_GUI2_export_LayoutFcn(policy)
...
'PlotBoxAspectRatio',[0.996784565916399 1 0.996784565916399],...
...
'Position',[0.317602040816326 0.32 0.395408163265306 0.565454545454545],...
'ActivePositionProperty','position',...
'ActivePositionPropertyMode',get(0,'defaultaxesActivePositionPropertyMode'),...
'LooseInset',[0.20953947368421 0.146577831617202 0.153125 0.099939430648092],...
...
'Color',[0 0 0],...
'ColorMode','auto',...
'Position',[0.500001245929349 1.00840032154341 0.5],...
'PositionMode','auto',...
'Interpreter','tex',...
...
'ColorMode','auto',...
'Position',[0.500000476837158 -0.086548768950173 0],...
'PositionMode','auto',...
'Interpreter','tex',...
'InterpreterMode','auto',...
'Rotation',0,...
...
'Color',[0.15 0.15 0.15],...
'ColorMode','auto',...
'Position',[-0.102688173735013 0.500000476837158 0],...
'PositionMode','auto',...
'Interpreter','tex',...
'InterpreterMode','auto',...
'Rotation',90,...
...
'String','YAY',...
'Style','text',...
'Position',[0.315051020408163 0.0855742296918768 0.396683673469388 0.151120448179272],...
'Children',[],...
'Tag','text2',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
elseif local_isInvokeHGCallback(gui_State, varargin{:})
    % UWB_GUI2_EXPORT('CALLBACK',hObject,eventData,handles,...)
    gui_Create = false;
else
    % UWB_GUI2_EXPORT(...)
